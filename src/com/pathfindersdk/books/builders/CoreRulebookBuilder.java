...
public class CoreRulebookBuilder extends BookBuilder
{
  ...
  protected void addRaces(Book book)
  {
    ...
    race.addBonus(new TypedBonus(2, BonusType.RACIAL, new AbilityBonusStrategy(AbilityType.CON)));
    race.addBonus(new TypedBonus(2, BonusType.RACIAL, new AbilityBonusStrategy(AbilityType.WIS)));
    race.addBonus(new TypedBonus(-2, BonusType.RACIAL, new AbilityBonusStrategy(AbilityType.CHA)));
    ...
    trait.addBonus(new TypedBonus(4, BonusType.DODGE, new ArmorBonusStrategy(), "against Giant subtype."));
    race.addTrait(trait);
    trait = new RacialTrait("Greed");
    trait.addBonus(new TypedBonus(2, BonusType.RACIAL, new SkillBonusStrategy("Appraise"), "on nonmagical goods that contain precious metals or gemstones."));
    race.addTrait(trait);
    ...
    trait.addBonus(new TypedBonus(4, BonusType.RACIAL, new CmdBonusStrategy("Bull Rush")));
    trait.addBonus(new TypedBonus(4, BonusType.RACIAL, new CmdBonusStrategy("Trip")));
    race.addTrait(trait);
    trait = new RacialTrait("Stonecunning");
    trait.addBonus(new TypedBonus(2, BonusType.UNTYPED, new SkillBonusStrategy("Perception"), "to notice traps and hidden doors in stone walls or floors."));
    race.addTrait(trait);
    ...
    race.addSpeed(new SpeedStat(20, SpeedType.ARMOR));
    race.addBonus(new TypedBonus(2, BonusType.RACIAL, new AbilityBonusStrategy(AbilityType.DEX)));
    race.addBonus(new TypedBonus(2, BonusType.RACIAL, new AbilityBonusStrategy(AbilityType.INT)));
    race.addBonus(new TypedBonus(-2, BonusType.RACIAL, new AbilityBonusStrategy(AbilityType.CON)));
    race.addBaseLanguage(Language.COMMON);
    ...
    trait.addBonus(new TypedBonus(2, BonusType.RACIAL, new SkillBonusStrategy("Spellcraft"), "to identify the properties of magic items."));
    race.addTrait(trait);
    trait = new RacialTrait("Keen Senses");
    trait.addBonus(new TypedBonus(2, BonusType.RACIAL, new SkillBonusStrategy("Perception")));
    race.addTrait(trait);
    // TODO: Weapon familiarity
    races.addItem(race);
    ...
    race.addBonus(new TypedBonus(2, BonusType.RACIAL, new AbilityBonusStrategy(AbilityType.CON)));
    race.addBonus(new TypedBonus(2, BonusType.RACIAL, new AbilityBonusStrategy(AbilityType.CHA)));
    race.addBonus(new TypedBonus(-2, BonusType.RACIAL, new AbilityBonusStrategy(AbilityType.STR)));
    race.addBaseLanguage(Language.COMMON);
    ...
    race.addSpeed(new SpeedStat(30, SpeedType.BASE));
    race.addSpeed(new SpeedStat(20, SpeedType.ARMOR));
    race.addBonus(new TypedBonus(2, BonusType.RACIAL, new AbilityBonusStrategy(AbilityType.ANY)));
    race.addBaseLanguage(Language.COMMON);
    race.addBaseLanguage(Language.ELVEN);
    ...
    trait.addBonus(new TypedBonus(2, BonusType.RACIAL, new SkillBonusStrategy("Intimidate")));
    race.addTrait(trait);
    ...
    trait.addBonus(new TypedBonus(2, BonusType.RACIAL, new SkillBonusStrategy("Acrobatics")));
    trait.addBonus(new TypedBonus(2, BonusType.RACIAL, new SkillBonusStrategy("Climb")));
    race.addTrait(trait);
    // TODO: Weapon familiarity
    races.addItem(race);
    ...
    trait.addBonus(new TypedBonus(1, BonusType.UNTYPED, new SkillRankBonusStrategy()));
    race.addTrait(trait);
    races.addItem(race);
